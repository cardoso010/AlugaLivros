...
namespace AlugaLivros.Controllers
{
    public class EmprestimosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmprestimoID,UsuarioID,DataInicio,DataFim,DataDevolucao,ApplicationUserId")] Emprestimo emprestimo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmprestimoID,UsuarioID,DataInicio,DataFim,DataDevolucao,ApplicationUserId")] Emprestimo emprestimo)
        {
